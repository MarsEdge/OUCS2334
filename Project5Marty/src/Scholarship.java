...
public class Scholarship implements Serializable{
	...
	private HashMap<String,Scholar> scholarList = new HashMap<String,Scholar>();
	...
	public HashMap<String, Scholar> getScholarList() {
		...
		for (Scholar scholar : scholarList.values()) {
	...
	public void addScholar(Scholar scholar) {
		scholarList.put(scholar.getName().getNameFull(),scholar);
	}
	...
	public void addPaper(Publication pub) {
		...
		for (Scholar scholar : pub.getScholars().values())
		{
			this.scholarList.get(scholar.getName().getNameFull()).addPublishedPaper(pub);
		}
	}
	...
	public void deleteAllPapers() {
		...
		for(Scholar scholar : scholarList.values())
		{
			scholar.getPublishedPapers().clear();
		}
	}
