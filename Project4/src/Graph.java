...
public class Graph extends JFrame{
	...
	public void setTypeOfGraph(String typeOfGraph) {
		...
		if(typeOfGraph=="TP"){
			...
			setTitle("Number of Each Type of Publication by " + getScholar().getNameFirst() + " " + getScholar().getNameLast());
			...
			setXLabel("Number of Publications");
			setYLabel("Year");
			setTitle("Number of Publications Each Year by " + getScholar().getNameFirst() + " " + getScholar().getNameLast());
			...
			setYLabel("Year");
			setTitle("Number of Conference Papers Each Year by " + getScholar().getNameFirst() + " " + getScholar().getNameLast());
			...
			setYLabel("Year");
			setTitle("Number of Journal Articles Each Year by " + getScholar().getNameFirst() + " " + getScholar().getNameLast());
			ArrayList<Publication> jPub = getScholar().getPublishedPapers();
			...
			setTitle("Number of Co Authors per Publication by " + getScholar().getNameFirst() + " " + getScholar().getNameLast());
